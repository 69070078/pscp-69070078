...
```text
โจทย์ให้รับค่า วัน และ เดือน ตรวจสอบว่า เดือนที่หาร3ลงตัวและวันที่21เป็นต้นไปจะเปลี่ยนฤดู
input: รับค่าสองค่า บรรทัดแรกเป็นเดือน ต่อมาเป็นวัน
output: ชื่อฤดูกาล
constraints: ควรระวังวันที่21ว่ามันคือนับตอนวันที่21หรือหลังจาก21
```
...
```text
1.รับค่าเดือน และวัน
2.ตรวจสอบว่าเดือนหาร3ไม่ลงจะทำให้printฤดูแบบปกติได้
3.ถ้าเกือนหาร3ลง ตรวจสอบจ่อว่าวันนั้นเป็นวันที่ 21หรือมากกว่าไหม
4.ถ้าใช่printฤดูการถัดจากเดือนที่อยู่
```
...
```text
วิะีสุดท้ายคล้ายวิธีแรกแต่ตัดขั้นต้อนตรวจสอบว่าหาร3ลงตัวไหมแล้ว แล้วมานั่งคิดและเขียนเงื่อนไขแต่ละเดือน=ฤดูไหนแทน
```
...
```text
เพราะเป็นวันที่21และเดือนหาร3ไม่ลง
```
...
```text
เพราะเป็นวันที่21และเดือนหาร3ลง
```
...
```text
เพราะเป็นเดือนรอยต่อระหว่างปีและ3หารลงตัว และเป็นวันที่21
```
