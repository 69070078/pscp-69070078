...
| OJ submission ID, if submitted | 	554309 |
| OJ status | Pass |
...
```text
ถามaiว่าจะprint if else ในบรรทัดเดียวกันทำได้ไหม
```
...
```text
เรื่องการprint ที่เราสาารถprint if else ในบรรทัดเดียวกันได้
```
...
```text
แก้ไข output ด้วยตนเองโดยการเขียน print(a if.. else b)
```
...
```text
เรียนรู้เรื่องpep-8ว่าหากมีการสร้างเงื่อนไขเยอะเกินจะทำให้ผิดหลัก แต่ก้แก้ไขได้โดยการย่อมา print if else ในบรรทัดเดียวกัน
```
