...
```text
โจทย์ให้ใส่ อุณหภูมิตั้งต้นแล้วเปลี่ยนเป็นอีกหนึ่งอุณหภูมิใน มีทั้งหมด4 อุณหภูมิ
input: โปรแกรมรับค่า 1.อุณหภูมิ 2.หน่วยเริ่มต้น 3.หน่วยที่ต้องการ
output:โปรแกรมควรพิมพ์อุณหภูมิที่ผ่านการแปลงจากหน่วยนึงไปอีกหน่วยนึง
constraints:-
```
...
```text
1.proframอ่านค่าจำวนวนจริง และ str ที่ต้องใส่ทั้ง3ตัว
2.ตรวจสอบว่าตัวอักษรแรกคือหน่วยอะไรแล้วเปลี่ยนเป็นหน่วย celcius
3.ตรวจสอบว่าตัวอักษรท้ายคือหน่วยอะไร แล้วทำการเปลี่ยนอุณหภูมิที่เก็บไว้ในหน่วยcelcius ไปเป็นอุณภูมิที่ต้องการ
...
```text
วิธีสุดท้ายคล้ายกับต้อนแรกแต่ลดรูปขั้นตอนของโค้ดลงมา
```
...
```text
เพราะต้องการรู้ว่าถ้าค่าเริ่มเป็นC code จะรวนไหม
```
...
```text
เพราะสูตรมีการคูณ หากคูณ0ควรตอบ0
```
