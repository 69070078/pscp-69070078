...
```text
โจทย์ให้ใส่ราคาอาหารและแล้วคิดราคาค่าบริการจากอาหารและคิดvatจากค่าอาหารบวกค่าบริการ
input:โปรแกรมรับค่าจำนวนเต็ม1ค่า
output:โปรแกรมควรพิมพ์ราคาอาหาร+ค่าบรการ+vat
constraints: ค่าบริการมีขั้นต่ำและสูงสุด
```
...
```text
1.อ่านจำนวนเต็มn
2.คิดหาค่าบริการ10%ของค่าอาหาร
3.คิดค่าvat จากค่าอาหาร+ค่าบริการ
4.พิพม์เงินที่ต้องจ่ายจากค่าอาหาร+ค่าบริการ+vat ด้วยทศนิยม2ตำแหน่ง
...
```text
วิธีสุดท้ายเหมือนกับแผนแรก ตั้งเงื่อนไขค่าบริการขั้นต่ำไว้50 สูงสุดไว้ที่1000 แล้วจากนั้นจึงนำไปคิดvatได้ แล้วสุดท้ายจึงนำค่าอาหาร+ค่าบริการ+vat
```
