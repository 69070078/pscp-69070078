...
```text
มีสีแม่สี3สี ใส่input2สี แล้วนำมาผสมกันหากมีสีอื่นที่ไม่ใช่แม่สีมาผสมให้พิมพ์error 
input: รับค่าstring สีเป็นภาาาอังกฤษ
output: เป็นค่าสีที่เกิดจากการผสมกันของแม่สี ถ้าไม่เกิดจากแม่สีจะพิมพ์error
constraints: สีแม่มีสามารถผสมกันเองได้ด้วย
```
...
```text
1.รับค่าสี 2 ค่า
2.ตรวจสอบว่าสีที่รับมาเป็นแม่สีไหม ถ้าไม่ print error
3.ถ้าใช่print สีที่กำหนด
```
...
```text
เหมือนตอนแรก แต่เพิ่มาคือตรวจสอบว่าinputทั้งสองเป็นแม่สีเดียวกันด้วย เพราะสีมันเองผสมกันก็ได้สีเดิม
```
...
```text
แนะนำtest case ที่คนอาจไม่รู้
```

คุณยังทำอะไรด้วยตนเอง

```text
วางแผนและเขียนcodeเองทั้งหมด
```
