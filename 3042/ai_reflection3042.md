...
| OJ submission ID, if submitted | 	560183 |
| OJ status | Pass |
...
```text
ถามai ถึงวิธีการแกะค่าในlistออกมาแยกกัน
```
...
```text
aiช่วยให้เห็นถึงการที่แกะค่าต่างๆในlist ออกมาเป็นargument แยกกัน
```
...
```text
การที่เก็บค่าไว้ในlist ค่ามันอยู่รวมกัน เวลาเราจะprintมันจะออกมาทั้ง[] แต่ถ้าเราใส่* ตอนprint*จะไปแยกค่าในlist ออกมาเป็น argument แยกกันก่อนส่งเข้าไปในฟังก์ชันprintทำให้เวลาprintออกมาเราจะไม่เห็น []และ,
```
