...
```text
โจทย์ให้อ่านค่าจำนวนเต็มบวกแล้วให้ตรวจว่าั้งแต่Nถึง0มีเลขที่หาร10ได้กี่ตัว
input:รับค่าจำนวนเต๋มบวกN
output:แสดงจำนวนเต็มบวกที่หาร10ลงตัว ทั้งหมดเรียงจากNไปถึงตัวสุดท้าย
constraints:-
```
...
```text
1.อ่านค่าจำนวนเต็มN
2.ตรวจสอบว่าNหาร10ลงตัวไหม
3.ถ้าไม่ก็-1ลงไปเรื่อยๆ
4.ถ้าใช่ก็เพิ่มจำนวนนั้นเข้าไปในlist
5.ลบเลขที่หาร10ลงตัวลงทีละ10
6.วนลูปจนถึง0
7.แสดงผลจำนวนทั้งหมดจากlist
```
...
```text
วิธีสุดท้ายคล้ายกับวิธีแรกแต่เพิ่มขั้นตอนการแกะจำนวนอออกมาจากlistีละตัว
```
...
```text
เพราะไม่ได้เริ่มด้วยตัวหาร10ลงตัว
```
...
```text
เพราะเริ่มจาก0เลยอยากรู้ว่ามันจะprintอะไร
```
