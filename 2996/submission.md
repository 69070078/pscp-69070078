...
```text
โจทย์ให้รับข้อความภาษาอังกฤษแล้วสลัตัวหลังมาหน้าหน้าไปหลัง
...
1.ใส่input
2.ใช้.lowerตรงinput
3.print input +ใช้string slicing ตรง step 
```
...
```text
วิธีสุดท้ายคล้ายแผนตอนแรก แต่เปลี่ยนเป็น.lowerตรงprintแทน
```
...
```text
ลองใช้string slicing จนได้outputแบบกลับหลังมา
```
